...
- **RequiredEntitlements** (group-level): If specified, each entry must be a valid entitlement (`NOTIFICATION_POLICIES`, `RUN_STATE_CHANGE_WEBHOOKS`); duplicates and empty values are rejected
